...
# 2016-04-15 09:39:47 by monisetup.php
# This is a config.php file for the MoniWiki
# automatically detect your environment and set some default variables.
# 2016-04-14 09:54:19 by monisetup.php
# This is a config.php file for the MoniWiki
# automatically detect your environment and set some default variables.
# 2016-04-14 09:53:35 by monisetup.php
# This is a config.php file for the MoniWiki
# automatically detect your environment and set some default variables.
# 2016-04-13 05:22:47 by monisetup.php
# This is a config.php file for the MoniWiki
# automatically detect your environment and set some default variables.
# 2016-04-13 05:22:30 by monisetup.php
# This is a config.php file for the MoniWiki
# automatically detect your environment and set some default variables.
# 2016-04-13 05:22:07 by monisetup.php
# This is a config.php file for the MoniWiki
# automatically detect your environment and set some default variables.
# 2016-04-13 01:13:57 by monisetup.php
# This is a config.php file for the MoniWiki
# automatically detect your environment and set some default variables.
# 2016-04-13 01:12:32 by monisetup.php
# This is a config.php file for the MoniWiki
# automatically detect your environment and set some default variables.
# 2016-04-13 01:08:50 by monisetup.php
# This is a config.php file for the MoniWiki
# automatically detect your environment and set some default variables.
# 2016-04-13 01:07:57 by monisetup.php
# This is a config.php file for the MoniWiki
# automatically detect your environment and set some default variables.
# 2016-04-12 10:37:08 by monisetup.php
# This is a config.php file for the MoniWiki
# automatically detect your environment and set some default variables.
# 2016-04-12 10:36:33 by monisetup.php
# @desc Default config file
#
$sitename='집에 돌아오면 반드시 위키니트가 되어 있습니다'; # site name
$wikimanager='생강'; # 위키지기 닉넴임 설정
$edit_unable="이 페이지는 수정할 수 없는 겁니다.<br>볼 수는 있지만, 저장 안시켜줄거에요?"; # 수정 불가능 페이지 수정 시 알람 메세지
...
$use_fakemtime=1; # dir mtime emulation for FAT filesytem.
$use_hashed_upload_dir=0; # use hashed upload dir to upload files into many subdirs
$use_hostname=0; # use hostname or ip address. SLOW SLOW
$use_htmlcolor=1; # use html color scheme
...
$lang='ko_KR.eucKR'; # check language automatically.
#$default_lang='ko_KR'; # default language
...
$pds_allowed="png|pneg|jpg|jpeg|gif|txt"; # some allowed file extension to upload.
...
<script type="text/javascript">
	var wikiManager = '$wikimanager',
		message_edit_unable = '$edit_unable';
</script>
META;
...
$javascripts=array(
	...
	'js/lve.js',
	'js/jquery.min.js',
	'js/jquery.beautyDialogBox.js',
	'js/jquery.beautyTitle.js',
	'js/custom_extend.js'
	);
...
$myplugins=array('rcsexport'=>false, '목차'=>'TableOfContents', '각주'=>'FootNote', 'SWFUpload'=>'UploadForm'); # substitute action/macro
...
#$use_safelogin=1;
#$use_ssl_login=1; # use https:// login url
...
#$use_local_translation=1; # automatic translation
...
$use_x_forwarded_for=1; # use X-Forwarded-For header information to log all pass-by addresses
...
$mobile_agents='android|iphone';
$dba_type="db4";
$seed="mPfNshheCvGdXI6eNkK989w7Da2uLnNYIFNlMsMfVeSG5fwxZINc1E1lbMTbM4fy";
$rcs_user="root";
$admin_passwd='3fo6ZkhrqAjss';
#$doctype=<<<doctype
#########<!DOCTYPE html>
#########<html lang="ko">
#########<head>
